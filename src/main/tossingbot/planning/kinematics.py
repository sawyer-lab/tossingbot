...
class CasadiKinematics:
    def __init__(self, urdf_path: str, base_link: str, end_link: str, 
        ...
        self.jacobian: ca.Function = None
    ...
    def _parse_urdf(self):
        ...
        for j in chain:
            ...
            # Determine if this joint should be active
            is_active = (j_type != 'fixed')
            if self.requested_active_joints is not None:
                is_active = is_active and (name in self.requested_active_joints)
    ...
    def _build_functions(self):
        ...
        for data in self._chain_data:
            ...
            if data['type'] != 'fixed':
                ...
                if data['name'] in self.active_joint_names:
                    qi = q[dof_index]
                    dof_index += 1
                else:
                    # Joint is moving in URDF but locked in this planner instance
                    qi = self.locked_joints.get(data['name'], 0.0)
        ...
        self.jacobian = ca.Function('jacobian', [q], [ca.jacobian(p, q)])
